...
from src.DDQN.models import build_flat_model
...
class DDQNAgent(object):
    ...
    def __init__(self, params: DDQNAgentParams, example_state, example_action, stats=None):
        ...
        print('################# Agent DDQN Example Action Length: ', len(type(example_action)))
        ...
        self.q_network = build_flat_model(states, self.num_actions, self.initial_mb, self.params.diagonal, self.params.tinymodel, self.params.masked)
        self.target_network = build_flat_model(states, self.num_actions, self.initial_mb, self.params.diagonal, self.params.tinymodel, self.params.masked, None,
                                                              'target_')
